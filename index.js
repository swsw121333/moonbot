...
client.on('message', (message) => {
  ...
  if(message.content == '!si') {
    ...
    embed.setAuthor('server info of MOON 문이 BOT', img)
    embed.setFooter(`MOON 문이 BOT ❤️`)
    embed.addBlankField()
  ...
  if(message.content == 'embed') {
    ...
    let commandList = [
      ...
      {name: '! MOON 문이#9999', desc: '그 외 설명은 ! MOON 문이#9999'},
    ];
    let commandStr = '';
    let embed = new Discord.RichEmbed()
      .setAuthor('Help of MOON BOT', helpImg)
      .setColor('#186de6')
      .setFooter(`문이봇 ❤️`)
      .setTimestamp()
